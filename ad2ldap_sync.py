...
OUT_USERS_BASEDN  = "ou=users,dc=georchestra,dc=univ-fcomte,dc=fr"
OUT_GROUPS_BASEDN = "ou=groups,dc=georchestra,dc=univ-fcomte,dc=fr"
OUT_DEFAULT_GROUPS = [ 'SV_USER' ]
...
def openldap_create_user(uid, in_user_attrs, dry_run = False):
  ...
  attrs['userpassword'] = '{SASL}'+attrs['uid'][0]+'@umrthema.univ-fcomte.fr'  # modify by Alexandre
...
def openldap_add_user_to_group(user_uid, group_uid, dry_run):
  ...
  group_dn = "cn=%s,%s" % (group_uid, OUT_GROUPS_BASEDN,)
